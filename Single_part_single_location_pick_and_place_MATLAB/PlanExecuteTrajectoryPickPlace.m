function [positions, velocities, accelerations, timestamp, success] = PlanExecuteTrajectoryPickPlace(robot, mpcTimeStep, obstacles, endEffector, jointInit, taskFinal, tolerance, avoidCollisions)
