classdef CoordinatorPickPlace < handle
    ...
    methods
        ...
        function visualizeWorld(obj)
            ...
            shelf = hgtransform;
            shelfB.Parent = shelf;
            shelf.Matrix = trvec2tform([-0.75 -0.02 -0.025]);
            ...
            trashcan.Matrix = trvec2tform([-0.04 0.56 -0.03]);
            
            % Render table
            fv = stlread('4table.stl');
            ...
            table = hgtransform;
            tableB.Parent = table;
            table.Matrix = trvec2tform([-0.7 -0.9 -0.025]);
        ...
        function visualizePath(obj, positions)
            ...
            obj.PathHandle = plot3(poses(:,1), poses(:,2), poses(:,3),'b--','LineWidth',2);            
            drawnow;
        end
